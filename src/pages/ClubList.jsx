...
import sortingClubs from "../services/sortingClubs";
...
export default function ClubList(){
    ...
    const sortedClubs = sortingClubs(sortBy);
    ...
    return(
        <div className="flex flex-col items-center min-h-screen gap-2 m-4">
            ...
            {/* <div className="flex justify-center gap-2"> */}
                ...
                {/* <select name="" id="" value={sortBy} onChange={(e) => {setSortBy(e.target.value), sortingClubs(e.target.value)}}> */}
                <select name="" id="" value={sortBy} onChange={(e) => {setSortBy(e.target.value)}}>
                {/* <select name="" id="" value={sortBy} onChange={sortingClubs(sortBy)}> */}
